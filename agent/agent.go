...
// Package agent contains the aggregate Agent structure along with the embedded Build, Comms, Host, and Process structures
// The in-memory repository only stores a single Agent structure because there should only ever be one
package agent
